class Perform_Surgery_TargetCB : ActionContinuousBaseCB
{
...
class Perform_Surgery_Target : ActionContinuousBase
{
	void Perform_Surgery_Target()
	{
		m_CallbackClass 	= Perform_Surgery_TargetCB;
	...
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		if (otherPlayer)
			return otherPlayer.HasDeepWounds() || otherPlayer.HasDeepWoundsBandaged();
