class ActionEsmarchsDIVSelfCB : ActionContinuousBaseCB
{
...
class ActionEsmarchsDIVSelf: ActionEsmarchsDIVBase
{	
	void ActionEsmarchsDIVSelf()
	{
		m_CallbackClass = ActionEsmarchsDIVSelfCB;
