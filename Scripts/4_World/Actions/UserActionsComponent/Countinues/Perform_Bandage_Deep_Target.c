class Perform_Bandage_Deep_TargetCB : ActionContinuousBaseCB
{
...
class Perform_Bandage_Deep_Target : ActionContinuousBase
{	
	void Perform_Bandage_Deep_Target()
	{
		m_CallbackClass 	= Perform_Bandage_Deep_TargetCB;
	...
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		return otherPlayer.HasDeepWounds();
	}
	...
	{	
		...
		if (action_data.m_MainItem && targetPlayer)
		{
			...
			targetPlayer.SetDeepWoundsBandaged();
