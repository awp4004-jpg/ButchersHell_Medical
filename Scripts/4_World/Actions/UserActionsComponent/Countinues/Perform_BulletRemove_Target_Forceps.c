class Perform_BulletRemove_Target_ForcepsCB : ActionContinuousBaseCB
{
...
class Perform_BulletRemove_Target_Forceps : ActionContinuousBase
{
	void Perform_BulletRemove_Target_Forceps()
	{
		m_CallbackClass 	= Perform_BulletRemove_Target_ForcepsCB;
