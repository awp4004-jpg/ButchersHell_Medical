class ActionCatsDIVTargetCB : ActionContinuousBaseCB
{
...
class ActionCatsDIVTarget: ActionCatsDIVBase
{
	void ActionCatsDIVTarget()
	{
		m_CallbackClass = ActionCatsDIVTargetCB;
	...
	{	
		...
		{
			ApplyDIVCat( action_data.m_MainItem, target );
