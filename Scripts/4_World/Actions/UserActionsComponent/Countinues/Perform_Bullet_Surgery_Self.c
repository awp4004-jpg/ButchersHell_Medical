class Perform_Bullet_Surgery_SelfCB : ActionContinuousBaseCB
{
...
class Perform_Bullet_Surgery_Self : ActionContinuousBase
{	
	void Perform_Bullet_Surgery_Self()
	{
		m_CallbackClass 	= Perform_Bullet_Surgery_SelfCB;
	...
	{
		return player.HasBulletWoundsRemoved();
	}
