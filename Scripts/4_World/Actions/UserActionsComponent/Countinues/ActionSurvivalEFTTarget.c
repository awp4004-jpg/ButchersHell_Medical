class ActionSurvivalDIVTargetCB : ActionContinuousBaseCB
{
...
class ActionSurvivalDIVTarget: ActionContinuousBase
{
	void ActionSurvivalDIVTarget()
	{
		m_CallbackClass 	= ActionSurvivalDIVTargetCB;  // Fixed: was using CMS callback
