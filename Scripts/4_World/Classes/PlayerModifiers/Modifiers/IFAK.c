class HealingIFAKMdfr : ModifierBase
{
    const int LIFETIME = 60;               // Total duration
    const int HEAL_DURATION = 35;          // Time it actually heals
    ...
    override void Init()
    {
        ...
        m_ID = new_DIV_eModifiers.MDF_HEALING_IFAK;
